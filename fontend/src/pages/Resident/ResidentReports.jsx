...
const ResidentReports = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // ✅ Thêm phản ánh mới vào danh sách
  ...
  if (loading)
    return <div className="reports-loading">Đang tải phản ánh...</div>;
    ...
    <div className="reports-page">
      ...
      >
        ...
        <div className="button-container">
          <button type="submit" className="report-button" disabled={submitting}>
            {submitting ? (
              "Đang gửi..."
            ) : (
              <>
        ...
        {reports.length === 0 ? (
          ...
          reports.map((r) => (
            ...
            >
              ...
              {/* ✅ Hiển thị ảnh phản ánh */}
              {r.images && r.images.length > 0 && (
                <div className="report-image">
                  <img
                    src={`https://quanlichungcumini.onrender.com${r.images[0]}`}
                    alt="Ảnh phản ánh"
                  />
                </div>
              )}
